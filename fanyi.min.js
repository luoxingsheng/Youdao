this.seajs = {
		_seajs: this.seajs
	}, seajs.version = "1.3.1", seajs._util = {}, seajs._config = {
		debug: "",
		preload: []
	},
	function(e) {
	...
	function(e, t, n) {
		...
		function o(e, i) {
			...
			g[o] ? i() : m[o] ? v[o].push(i) : (m[o] = !0, v[o] = [i], r._fetch(o, function() {
				g[o] = !0;
				var n = d[e];
				n.status === h.FETCHING && (n.status = h.FETCHED), y && (r._save(e, y), y = null), b && n.status === h.FETCHED && (d[e] = b, b.realUri = e), b = null, m[o] && delete m[o], (n = v[o]) && (delete v[o], t.forEach(n, function(e) {
					e()
				}))
			}, n.charset))
		}
	...
	function(e, t, n) {
		...
		! function(e, t) {
			...
			var n, r, i, o = e,
				...
				te = function(e, t) {
					...
					if ("string" == typeof e && e ? o = e.toLowerCase().split(/\s+/) : "object" != typeof e || !e || "length" in e || void 0 !== t || x(e).forEach(function(t) {
						...
						if (a.ready && H.ready && Ke.emit({
								type: "ready"
							}), a.error) {
							for (Q() || Ke.emit({
									type: "error",
									name: "browser-unsupported"
								}), r = 0, i = V.length; r < i; r++)
				...
				ne = function(e, t) {
					var n, r, i, o, a;
					if (0 === arguments.length ? o = x(z) : "string" == typeof e && e ? o = e.toLowerCase().split(/\s+/) : "object" != typeof e || !e || "length" in e || void 0 !== t || x(e).forEach(function(t) {
							var n = e[t];
				...
				ae = function() {
					...
					if (!Q()) return H.ready = !1, void Ke.emit({
						type: "error",
						name: "browser-unsupported"
					});
					...
					})) : Ke.isFlashUnusable() || null !== H.bridge || ((t = oe()) && t !== o.location.protocol ? Ke.emit({
						type: "error",
						name: "flash-insecure"
				...
				xe = function(e) {
					if ("object" == typeof e && e && e.type) {
						...
						if (i && i.length) {
							...
							for (a = 0, s = i.length; a < s; a++) c = d, "string" == typeof(l = i[a]) && "function" == typeof o[l] && (l = o[l]), "object" == typeof l && l && "function" == typeof l.handleEvent && (c = l, l = l.handleEvent), "function" == typeof l && (u = C({}, e), be(l, c, [u], t))
						}
						return this
					}
				},
				we = function(e) {
					var t = null;
					return (!1 === q || e && "error" === e.type && e.name && -1 !== X.indexOf(e.name)) && (t = !1), t
				},
				Te = function(e) {
					...
					switch (delete e._source, e.type) {
						case "error":
							...
							"boolean" == typeof a && (H.sandboxed = a), "browser-unsupported" === e.name ? C(H, {
								disabled: !1,
								outdated: !1,
								unavailable: !1,
								degraded: !1,
						...
						case "aftercopy":
							...
							break;
						case "_mouseover":
							Ke.focus(t), !0 === K.bubbleEvents && o && (t && t !== e.relatedTarget && !A(e.relatedTarget, t) && ke(C({}, e, {
								type: "mouseenter",
								bubbles: !1,
								cancelable: !1
							})), ke(C({}, e, {
							...
							break;
						case "_mouseout":
							Ke.blur(), !0 === K.bubbleEvents && o && (t && t !== e.relatedTarget && !A(e.relatedTarget, t) && ke(C({}, e, {
								type: "mouseleave",
								bubbles: !1,
								cancelable: !1
							})), ke(C({}, e, {
							...
							break;
						case "_mousedown":
							Ie(t, K.activeClass), !0 === K.bubbleEvents && o && ke(C({}, e, {
								type: e.type.slice(1)
							}));
							break;
						case "_mouseup":
							He(t, K.activeClass), !0 === K.bubbleEvents && o && ke(C({}, e, {
								type: e.type.slice(1)
							}));
							break;
						case "_click":
							i = null, !0 === K.bubbleEvents && o && ke(C({}, e, {
								type: e.type.slice(1)
							}));
							break;
						case "_mousemove":
							!0 === K.bubbleEvents && o && ke(C({}, e, {
								type: e.type.slice(1)
							}))
					}
			...
			Ke.version = "2.4.0-beta.1", Ke.config = function() {
				...
				return ae.apply(this, k(arguments))
			}, Ke.destroy = function() {
			...
			var nt = function(e) {
				...
				at = function(e) {
					var t, n = this;
					return dt.call(n, e) && ("object" == typeof e && e && "string" == typeof e.type && e.type && (e = C({}, e)), t = C({}, me(e), {
						client: n
					}), ft.call(n, t)), n
				},
				st = function(e) {
				...
				ft = function(e) {
					...
					if ("object" == typeof e && e && e.type && t) {
						...
						if (a && a.length) {
							...
							for (s = 0, l = a.length; s < l; s++) u = f, "string" == typeof(c = a[s]) && "function" == typeof o[c] && (c = o[c]), "object" == typeof c && c && "function" == typeof c.handleEvent && (u = c, c = c.handleEvent), "function" == typeof c && (d = C({}, e), be(c, u, [d], n))
						}
					}
				},
				pt = function(e) {
		...
		function i() {
			a("#urs-login-block").remove(), a("#loginWindow .content").append("<div id='urs-login-block' style='width:400px;'></div>")
		}
		...
		"http:" === window.location.protocol && (b.isHttps = 0, b.PROTOCOL = "http", b.REGPROTOCOL = "http"), t.init = function() {
			if (s.find(".dialog-alert--close").on("click", function() {
					...
					r()
				}), n(m, "js"), n(g, "js"), n(v, "css"), a(".login-link").on("click", function() {
					i(), o(), p.clog("LOGIN_CLICK", ""), l.show(), c.show(), (y = new URS(b)).logincb = function(e, t, n) {
						...
						a.ajax({
							...
							data: {
								...
								tp: "urscookie",
								cf: 7,
								ru: "https://fanyi.youdao.com",
								product: "DICT",
								show: !0,
								samesite: "https:" === window.location.protocol
							}
						}).done(function(e) {
		...
		t.init = function() {
			r("https://shared.ydstatic.com/ead/js/dict_req_web_1.1.js", {
		...
		r(function() {
			function e(e) {
				a.contentWindow.postMessage(JSON.stringify(e), "*")
			}
	...
	function(e) {
		...
		function s(e) {
			p(".upload__percent").text(e.percent), p(".upload__filename").text(e.name), p(".upload__progress").css({
				width: e.percent
			})
		}
		...
		t.init = function() {
			i(), y.on("click", function() {
				...
				if (h.switchMode(!0), t.isDocMode = !0, t.isDocReady = !1, p("#docLangTip").show(), e && e[0] && e[0].size && (n = e[0].size), "" != (i = e && e[0] && e[0].name ? e[0].name : i.split("\\")[i.split("\\").length - 1])) {
					if (!/(.docx|.pdf|.doc|.ppt|.pptx)$/i.test(i)) return o(!0, {
						msg: "鏂囨。鏍煎紡閿欒,鐩墠浠呮敮鎸乨oc/docx/pdf/pptx/ppt鏍煎紡",
						name: i,
						size: r(n)
				...
				a(), x.val(""), p("#docLangTip").hide(), h.switchMode(!1), f(), t.isDocMode = !1, t.isDocReady = !1
		...
		var r = e("./jquery-1.7"),
			...
			d = function(e) {
				r.ajax({
					type: "GET",
					url: "https://gorgon.youdao.com/gorgon/eadd/request.s",
					data: {
			...
			e.fn.attr2 = function() {
				...
				function c(n) {
					...
					function o() {
						...
						_.setAttribute("target", h), u && !/post/i.test(u) || _.setAttribute("method", "POST"), o !== d.url && _.setAttribute("action", d.url), d.skipEncodingOverride || u && !/post/i.test(u) || p.attr({
						...
						if (!y.aborted && !L) {
							...
							if (O && O.location.href !== d.iframeSrc || w) {
								...
								try {
									...
									y.responseText = l ? l.innerHTML : null, y.responseXML = O.XMLDocument ? O.XMLDocument : O, a && (d.dataType = "xml"), y.getResponseHeader = function(e) {
										return {
				...
				for (u = 0, m = c.length; u < m; u++)
					if (h = c[u], (f = h.name) && !h.disabled)
						if (t && s.clk && "image" === h.type) s.clk === h && (i.push({
							name: f,
							value: e(h).val(),
							type: h.type
						}), i.push({
					...
					for (n && n.push(h), d = 0, g = p.length; d < g; d++) i.push({
						name: f,
						value: p[d]
					});
		...
		return function(e, t) {
			...
			function r(e, n, r) {
				if (r === t && 1 === e.nodeType) {
					...
					if ("string" == typeof(r = e.getAttribute(i))) {
						try {
							r = "true" === r || "false" !== r && ("null" === r ? null : R.isNumeric(r) ? parseFloat(r) : I.test(r) ? R.parseJSON(r) : r)
						} catch (e) {}
						R.data(e, n, r)
					} else r = t
				}
			...
			function v(e, t) {
				t.src ? R.ajax({
					...
					async: !1,
					dataType: "script"
				}) : R.globalEval((t.text || t.textContent || t.innerHTML || "").replace(Ce, "/*$0*/")), t.parentNode && t.parentNode.removeChild(t)
			}
			...
			function y(e, t, n) {
				...
				}), r + "px") : (((r = je(e, t, t)) < 0 || null == r) && (r = e.style[t] || 0), r = parseFloat(r) || 0, n && R.each(i, function() {
			...
			function x(e, n, r, i, o, a) {
				...
				for (var s, l = e[o], c = 0, u = l ? l.length : 0, d = e === it; c < u && (d || !s); c++) "string" == typeof(s = l[c](n, r, i)) && (!d || a[s] ? s = t : (n.dataTypes.unshift(s), s = x(e, n, r, i, s, a)));
				return !d && s || a["*"] || (s = x(e, n, r, i, "*", a)), s
			}
				...
				for (r = 1; r < p; r++) {
					...
					if (a = h, "*" === (h = d[r])) h = a;
						...
						if (s = a + " " + h, !(l = f[s] || f["* " + h])) {
							u = t;
							for (c in f)
								if (((o = c.split(" "))[0] === a || "*" === o[0]) && (u = f[o[1] + " " + h])) {
									!0 === (c = f[c]) ? l = u : !0 === u && (l = c);
									break
								}
						}
			...
			function E() {
				return setTimeout(j, 0), mt = R.now()
			}
			...
			var O = e.document,
				...
				R = function() {
					...
					}), (i = s.uaMatch(E)).browser && (s.browser[i.browser] = !0, s.browser.version = i.version), s.browser.webkit && (s.browser.safari = !0), d.test("聽") && (f = /^[\s\xA0]+/, p = /[\s\xA0]+$/), r = s(O), O.addEventListener ? a = function() {
			...
			R.Callbacks = function(e) {
				...
				var r, i, o, a, s, l = [],
					...
					u = function(t) {
						var n, r, i, o;
						for (n = 0, r = t.length; n < r; n++) i = t[n], "array" === (o = R.type(i)) ? u(i) : "function" === o && (e.unique && f.has(i) || l.push(i))
					},
					d = function(t, n) {
			...
			R.extend({
				...
				when: function(e) {
					...
					if (r > 1) {
						for (; n < r; n++) t[n] && t[n].promise && R.isFunction(t[n].promise) ? t[n].promise().then(function(e) {
							return function(n) {
								t[e] = arguments.length > 1 ? q.call(arguments, 0) : n, --o || a.resolveWith(a, t)
							}
						}(n), a.reject, function(e) {
							return function(t) {
								i[e] = arguments.length > 1 ? q.call(arguments, 0) : t, a.notifyWith(s, i)
							}
						}(n)) : --o;
						o || a.resolveWith(a, t)
				...
				if (u.appendChild(g), (c = l || v).insertBefore(u, c.firstChild), a.appendChecked = i.checked, a.boxModel = 2 === g.offsetWidth, "zoom" in g.style && (g.style.display = "inline", g.style.zoom = 1, a.inlineBlockNeedsLayout = 2 === g.offsetWidth, g.style.display = "", g.innerHTML = "<div style='width:4px;'></div>", a.shrinkWrapBlocks = 2 !== g.offsetWidth), g.innerHTML = "<table><tr><td style='padding:0;border:0;display:none'></td><td>t</td></tr></table>", f = g.getElementsByTagName("td"), m = 0 === f[0].offsetHeight, f[0].style.display = "", f[1].style.display = "none", a.reliableHiddenOffsets = m && 0 === f[0].offsetHeight, g.innerHTML = "", O.defaultView && O.defaultView.getComputedStyle && ((o = O.createElement("div")).style.width = "0", o.style.marginRight = "0", g.appendChild(o), a.reliableMarginRight = 0 === (parseInt((O.defaultView.getComputedStyle(o, null) || {
						marginRight: 0
					}).marginRight, 10) || 0)), g.attachEvent)
					for (h in {
							submit: 1,
							change: 1,
							focusin: 1
			...
			R.fn.extend({
				...
				attr: function(e, n, r, i) {
					...
					return e && 3 !== l && 8 !== l && 2 !== l ? i && n in R.attrFn ? R(e)[n](r) : "getAttribute" in e ? ((s = 1 !== l || !R.isXMLDoc(e)) && (n = n.toLowerCase(), a = R.attrHooks[n] || (Z.test(n) ? P : z)), r !== t ? null === r ? (R.removeAttr(e, n), t) : a && "set" in a && s && (o = a.set(e, r, n)) !== t ? o : (e.setAttribute(n, "" + r), r) : a && "get" in a && s && null !== (o = a.get(e, n)) ? o : null === (o = e.getAttribute(n)) ? t : o) : R.prop(e, n, r) : t
				},
				...
				attrHooks: {
					...
					value: {
						get: function(e, t) {
							return z && R.nodeName(e, "button") ? z.get(e, t) : t in e ? e.value : null
						},
						set: function(e, t, n) {
			...
			}), R.attrHooks.tabindex = R.propHooks.tabIndex, P = {
				get: function(e, n) {
					var r, i = R.prop(e, n);
			...
			}, R.attrHooks.tabindex.set = z.set, R.each(["width", "height"], function(e, t) {
			...
			R.event = {
					add: function(e, n, r, i, o) {
						...
						if (3 !== e.nodeType && 8 !== e.nodeType && n && r && (a = R._data(e))) {
							for (r.handler && (r = (h = r).handler), r.guid || (r.guid = R.guid++), (l = a.events) || (a.events = l = {}), (s = a.handle) || (a.handle = s = function(e) {
								...
								}, s.elem = e), n = oe(n).split(" "), c = 0; c < n.length; c++) d = (u = J.exec(n[c]) || [])[1], f = (u[2] || "").split(".").sort(), g = R.event.special[d] || {}, d = (o ? g.delegateType : g.bindType) || d, g = R.event.special[d] || {}, p = R.extend({
								type: d,
								origType: u[1],
								data: i,
								handler: r,
								...
								selector: o,
								namespace: f.join(".")
							}, h), o && (p.quick = re(o), !p.quick && R.expr.match.POS.test(o) && (p.isPositional = !0)), (m = l[d]) || ((m = l[d] = []).delegateCount = 0, g.setup && !1 !== g.setup.call(e, i, f, s) || (e.addEventListener ? e.addEventListener(d, s, !1) : e.attachEvent && e.attachEvent("on" + d, s))), g.add && (g.add.call(e, p), p.handler.guid || (p.handler.guid = r.guid)), o ? m.splice(m.delegateCount++, 0, p) : m.push(p), R.event.global[d] = !0;
							e = null
						}
					},
					global: {},
				...
				}, R.event.handle = R.event.dispatch, R.removeEvent = O.removeEventListener ? function(e, t, n) {
				...
				function() {
					...
					var f = function(e, t, n, i) {
						...
						if (T.length > 1 && m.exec(e))
							...
							for (l = (d = i ? {
									expr: T.pop(),
									set: v(i)
								} : f.find(T.pop(), 1 !== T.length || "~" !== T[0] && "+" !== T[0] || !t.parentNode ? t : t.parentNode, w)).expr ? f.filter(d.expr, d.set) : d.set, T.length > 0 ? c = v(l) : b = !1; T.length;) g = p = T.pop(), h.relative[p] ? g = T.pop() : p = "", null == g && (g = t), h.relative[p](c, g, w);
						else c = T = [];
					...
					f.uniqueSort = function(e) {
						...
						for (i = 0, o = h.order.length; i < o; i++)
							if (s = h.order[i], (a = h.leftMatch[s].exec(e)) && (l = a[1], a.splice(1, 1), "\\" !== l.substr(l.length - 1) && (a[1] = (a[1] || "").replace(c, ""), null != (r = h.find[s](a, t, n))))) {
			...
			R.fn.extend({
				...
				is: function(e) {
					return !!e && ("string" == typeof e ? de.test(e) ? R(e, this.context).index(this[0]) >= 0 : R.filter(e, this).length > 0 : this.filter(e).length > 0)
				},
			...
			Se.optgroup = Se.option, Se.tbody = Se.tfoot = Se.colgroup = Se.caption = Se.thead, Se.th = Se.td, R.support.htmlSerialize || (Se._default = [1, "div<div>", "</div>"]), R.fn.extend({
				...
				domManip: function(e, n, r) {
					...
					if (this[0]) {
						if (s = l && l.parentNode, i = R.support.parentNode && s && 11 === s.nodeType && s.childNodes.length === this.length ? {
							...
							n = n && R.nodeName(o, "tr");
							for (var u = 0, f = this.length, p = f - 1; u < f; u++) r.call(n ? d(this[u]) : this[u], i.cacheable || f > 1 && u < p ? R.clone(a, !0, !0) : a)
						}
						c.length && R.each(c, v)
					}
					return this
				...
				var r, i, o, a, s = e[0];
				return t && t[0] && (a = t[0].ownerDocument || t[0]), a.createDocumentFragment || (a = O), 1 === e.length && "string" == typeof s && s.length < 512 && a === O && "<" === s.charAt(0) && !we.test(s) && (R.support.checkClone || !_e.test(s)) && !R.support.unknownElems && Te.test(s) && (i = !0, (o = R.fragments[s]) && 1 !== o && (r = o)), r || (r = a.createDocumentFragment(), R.clean(e, a, r, n)), i && (R.fragments[s] = o ? r : 1), {
					fragment: r,
					cacheable: i
				}
			}, R.fragments = {}, R.each({
			...
			R.fn.css = function(e, n) {
				...
				css: function(e, n, r) {
					var i, o;
					return n = R.camelCase(n), o = R.cssHooks[n], "cssFloat" === (n = R.cssProps[n] || n) && (n = "float"), o && "get" in o && (i = o.get(e, !0, r)) !== t ? i : je ? je(e, n) : void 0
				},
				swap: function(e, t, n) {
					var r = {};
				...
				R.cssHooks[t] = {
					get: function(e, n, r) {
						var i;
						if (n) return 0 !== e.offsetWidth ? y(e, t, r) : (R.swap(e, qe, function() {
							i = y(e, t, r)
						}), i)
					},
					set: function(e, t) {
				...
				var r, i, o;
				return n = n.replace(Le, "-$1").toLowerCase(), (i = e.ownerDocument.defaultView) ? ((o = i.getComputedStyle(e, null)) && ("" !== (r = o.getPropertyValue(n)) || R.contains(e.ownerDocument.documentElement, e) || (r = R.style(e, n))), r) : t
			...
			R.fn.extend({
				show: function(e, t, n) {
					...
					for (var o = 0, a = this.length; o < a; o++)(r = this[o]).style && (i = r.style.display, R._data(r, "olddisplay") || "none" !== i || (i = r.style.display = ""), "" === i && "none" === R.css(r, "display") && R._data(r, "olddisplay", A(r.nodeName)));
				...
				animate: function(e, t, n, r) {
					function i() {
						...
						for (r in e) {
							if (t = R.camelCase(r), r !== t && (e[t] = e[r], delete e[r]), n = e[t], R.isArray(n) ? (d.animatedProperties[t] = n[1], n = e[t] = n[0]) : d.animatedProperties[t] = d.specialEasing && d.specialEasing[t] || d.easing || "swing", "hide" === n && p || "show" === n && !p) return d.complete.call(this);
							!f || "height" !== t && "width" !== t || (d.overflow = [this.style.overflow, this.style.overflowX, this.style.overflowY], "inline" === R.css(this, "display") && "none" === R.css(this, "float") && (R.support.inlineBlockNeedsLayout && "inline" !== A(this.nodeName) ? this.style.zoom = 1 : this.style.display = "inline-block"))
						}
				...
				custom: function(e, n, r) {
					...
					var o = this,
						a = R.fx;
					this.startTime = mt || E(), this.end = n, this.now = this.start = e, this.pos = this.state = 0, this.unit = r || this.unit || (R.cssNumber[this.prop] ? "" : "px"), i.queue = this.options.queue, i.elem = this.elem, i.saveState = function() {
		...
		function a(e) {
			function t(e) {
				var t = f("#langSelect span.select-text").text().indexOf("妫€娴嬪埌") > -1,
					n = f.trim(f("#langSelect span.select-text").text()).replace("妫€娴嬪埌锛�", "").replace(/\s+/g, "");
				if (n.indexOf("禄") < 0) {
					if ("from" === e) return "auto";
					if ("to" === e) return "auto"
				}
				return n = n.split("禄"), "from" === e ? t ? "auto" : o(n[0]) : "to" === e ? t ? "auto" : o(n[1]) : void 0
			}
			var n = f.trim(w.val());
			n = n.replace(/\n/g, "").replace(/\r\n/g, "");
		...
		function s(e) {
			if (0 == f('li[data-value="' + e + '"]').length) f("#langSelect").selectValue("AUTO");
				...
				L.state.isSelectLan || f(".select-text").text("妫€娴嬪埌锛�" + t)
			}
		}
		...
		! function() {
			...
			T.delegate("span", "mouseover", function() {
				...
				o(), g = !0, f("#transTarget span.hover").removeClass("hover"), i()
			}), f(".input__target").on("mouseup", function(e) {
				null == p.getSelectionText() && (g = !1), a()
			...
			if (M(), _.text(i), i > 5e3) {
				...
				var s = o.substr(5e3);
				s = (s = s.trim()).substr(0, 3), f("#inputTargetError").text("鏈夐亾缈昏瘧瀛楁暟闄愬埗涓�5000瀛楋紝鈥�" + s + "鈥濆強鍏跺悗闈㈡病鏈夎缈昏瘧!").show(), _.addClass("fonts__overed")
		...
		return {
			...
			isWeb: function(e) {
				...
				return {
					...
					unicode_tlds: "啶曕啶� 銈汇兗銉� 浣涘北 嗖簿嗖班菠 鎱堝杽 闆嗗洟 鍦ㄧ嚎 頃滉淡 喱喱班 澶т紬姹借溅 鐐圭湅 喔勦腑喔� 唳唰班Δ 唳唳班Δ 鍏崷 賲賵賯毓 唳唳傕Σ唳� 鍏泭 鍏徃 棣欐牸閲屾媺 缃戠珯 绉诲姩 鎴戠埍浣� 屑芯褋泻胁邪 覜邪蟹 泻邪褌芯谢懈泻 芯薪谢邪泄薪 褋邪泄褌 鑱旈€� 褋褉斜 斜谐 斜械谢 拽讜诐 鏃跺皻 寰崥 娣￠┈閿� 銉曘偂銉冦偡銉с兂 芯褉谐 啶ㄠ啶� 銈广儓銈� 靷检劚 喈氞喈權瘝喈曕喁嵿喁傕喁� 鍟嗘爣 鍟嗗簵 鍟嗗煄 写械褌懈 屑泻写 械褞 銉濄偆銉炽儓 鏂伴椈 宸ヨ 瀹堕浕 賰賵賲 涓枃缃� 涓俊 涓浗 涓湅 濞变箰 璋锋瓕 喟熬喟班挨啾� 喽洁秱喽氞窂 闆昏▕鐩堢 璐墿 銈儵銈︺儔 嗒嗒班 閫氳博 啶ぞ啶班い啶 啶ぞ啶班い 啶ぞ啶班啶� 缃戝簵 啶膏啶椸啶� 椁愬巺 缃戠粶 泻芯屑 褍泻褉 棣欐腐 璇哄熀浜� 椋熷搧 椋炲埄娴� 鍙版咕 鍙扮仯 鎵嬭〃 鎵嬫満 屑芯薪 丕賱噩夭丕卅乇 毓賲丕賳 丕乇丕賲賰賵 丕蹖乇丕賳 丕賱毓賱賷丕賳 丕鬲氐丕賱丕鬲 丕賲丕乇丕鬲 亘丕夭丕乇 賲賵乇賷鬲丕賳賷丕 倬丕讴爻鬲丕賳 丕賱丕乇丿賳 亘丕乇鬲 亘诰丕乇鬲 丕賱賲睾乇亘 丕亘賵馗亘賷 丕賱亘丨乇賷賳 丕賱爻毓賵丿賷丞 趢丕乇鬲 賰丕孬賵賱賷賰 爻賵丿丕賳 賴賲乇丕賴 毓乇丕賯 賲賱賷爻賷丕 婢抽杸 雼缝淮 鏀垮簻 卮亘賰丞 亘賷鬲賰 毓乇亘 醿掅償 鏈烘瀯 缁勭粐鏈烘瀯 鍋ュ悍 喙勦笚喔� 爻賵乇賷丞 鎷涜仒 褉褍褋 褉褎 鐝犲疂 鬲賵賳爻 澶ф嬁 嗪ム翰嗪� 銇裤倱銇� 銈般兗銈般儷 蔚蠀 蔚位 涓栫晫 鏇哥睄 啻淳啻班搐啻� 啜ň啜班à 缃戝潃 雼冯劮 銈炽儬 澶╀富鏁� 娓告垙 verm枚gensberater verm枚gensberatung 浼佷笟 淇℃伅 鍢夐噷澶ч厭搴� 鍢夐噷 賲氐乇 賯胤乇 骞夸笢 喈囙喈權瘝喈曕瘓 喈囙喁嵿喈苦喈� 瞻铡盏 鏂板姞鍧� 賮賱爻胤賷賳 鏀垮姟".split(" ")
				}.ascii_tlds.forEach(function(e) {
					r[e.toLowerCase()] = 1
				}), !(!r[n] || t.length < 2) && /^(?:([A-Za-z]+):)?(\/{0,3})([0-9.\-A-Za-z]+)(?::(\d+))?(?:\/([^?#]*))?(?:\?([^#]*))?(?:#(.*))?$/gi.test(e.toLocaleString())
			},
			addToFav: function() {
				t.browser.msie ? window.external.addFavorite("https://fanyi.youdao.com/?keyfrom=favorite", "鏈夐亾缈昏瘧 - 鍏嶈垂鍦ㄧ嚎缈昏瘧") : alert("璇蜂娇鐢–trl + D 鎵嬪姩鍔犲叆鏀惰棌")
			},
			...
			throttle: function(e, t, n, r) {
				...
				function o() {
					...
					var c = this,
						u = Date.now() - l,
						d = arguments;
					s || (r && !a && o(), i(), void 0 === r && u > e ? o() : !0 !== t && (a = setTimeout(r ? function() {
						a = void 0
					} : o, void 0 === r ? e - u : e)))
				}
				var a, s = !1,
					l = 0;
				return "boolean" != typeof t && (r = n, n = t, t = void 0), o.cancel = function() {
					i(), s = !0
				}, o
			},
		...
		var n = e("./jquery-1.7"),
			...
			h = function(e, t, n) {
				...
				return "https://tts.youdao.com/fanyivoice?word=" + encodeURIComponent(e) + "&le=" + t + "&keyfrom=" + n
			},
			m = function(e) {
		...
		t.stopVoice = function() {
			...
			f[e] && g() <= 300 ? (s.removeClass("speaker-disable").show(), s.find(".tips__text--short").text("鏈楄")) : f[e] && g() > 300 ? (s.addClass("speaker-disable").show(), s.find(".tips__text--short").text("鏂囨湰杩囬暱锛屾湕璇诲叧闂�")) : s.hide()
		}, t.init = function() {
		...
		function s(e) {
			...
			u[0].scrollTop = 0, d[0] ? (t.addClass("input__small__font"), t.css({
				...
				"font-size": "24px",
				"line-height": "30px"
			}), h.state.smallFont = !1), d[1] ? c.hide() : c.show(), "" != l.trim(s) ? (o(), f.resizeTextarea(u[0]), l("#transTarget").removeClass("input__target__text--updated"), p.translate(e, function() {
				r()
